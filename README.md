...
В ходе поднятия контейнеров с базами данных возникли проблемы с портами. Поэтому для PostgreSql был установлен порт 5433 на хосте (в контейнере остался 5432), а для MySql - 3307 на хосте (в контейнере остался 3306)
